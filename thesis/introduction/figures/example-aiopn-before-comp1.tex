...
\node[transition,rotate=90,label={[yshift=0,xshift=13]0:$\transition{msg!}$},enabled] at (1,-1.5) (tmsg_out) {};
\node[place,tokens=0,label=below:$q_1$] at (0,-3) (p1) {};
\node[transition,rotate=90,label={[yshift=0,xshift=0]90:$\transition{in?}$}] at (-1,-1.5) (ta_in) {};
